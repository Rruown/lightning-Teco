...
if module_available("lightning"):
    ...
    from lightning.strategies.fsdp import FSDPStrategy
    from lightning.utilities.rank_zero import rank_zero_warn
...
from lightning_teco.strategies.ddp import SDAAParallelStrategy
from lightning_teco.utils.imports import _LIGHTNING_GREATER_EQUAL_2_3_0
...
class SDAAFSDPStrategy(FSDPStrategy, SDAAParallelStrategy):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if not _LIGHTNING_GREATER_EQUAL_2_3_0:
            raise OSError("SDAAFSDPStrategy requires `lightning>=2.3.0 or pytorch-lightning >= 2.3.0`.")
    ...
    def reduce(
        ...
        return SDAAParallelStrategy.reduce(self, tensor, group, reduce_op)

    def _get_process_group_backend(self) -> str:
        return SDAAParallelStrategy._get_process_group_backend(self)
