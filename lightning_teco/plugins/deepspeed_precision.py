...
if module_available("lightning"):
    ...
    from lightning.utilities.rank_zero import WarningCache
...
from lightning_teco.plugins.precision import _PRECISION_INPUT, SDAAPrecisionPlugin
from lightning_teco.utils.resources import _SDAA_AVAILABLE
