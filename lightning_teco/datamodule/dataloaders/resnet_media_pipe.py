...
import lightning_teco.datamodule.utils as utils
...
if _SDAA_AVAILABLE:
    try:
        ...
        from habana_frameworks.mediapipe.plugins.iterator_pytorch import SDAAResnetPytorchIterator
    except ImportError:
    ...
    class MediaApiDataLoader(torch.utils.data.DataLoader):
        ...
        def __init__(
            ...
            self.iterator = SDAAResnetPytorchIterator(mediapipe=pipeline)
